...
tsGUI= uicontrol(gcf,...
    'Style','edit',...
    'String','0',...
    'Position',[60,60,30,30], ... %[left, bottom, right, top] (or horz, vert)
    'CallBack', 'uiresume;');
ts_chosen = 0;
durGUI= uicontrol(gcf,...
    'Style','edit',...
    'String','30',...
    'Position',[60,90,30,30], ... %[left, bottom, right, top] (or horz, vert)
    'CallBack', 'uiresume;');
dur_chosen = 30;
zrGUI= uicontrol(gcf,...
    'Style','edit',...
    'String','0',...
    'Position',[60,120,30,30], ... %[left, bottom, right, top] (or horz, vert)
    'CallBack', 'uiresume;');
zr_chosen = 0;
...
lab_ts = uicontrol(gcf,'Style','text','String','start time (s)','Position',[0,60,60,30]);
lab_dur = uicontrol(gcf,'Style','text','String','duration (s)','Position',[0,90,60,30]);
lab_zr = uicontrol(gcf,'Style','text','String','zrange','Position',[0,120,60,30]);
...
while true
    ...
    for ne=1:Nelec_atonce
        subplot_tight(Nelec_atonce,1,ne,[.05,.05])
        ...
        if ~isempty(shade_blue)
            shade_blue_per = chunkInts(shade_blue,1)/1000;
